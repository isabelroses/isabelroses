...
- [flo-bit/bluesky-wrapped](https://github.com/flo-bit/bluesky-wrapped) (1 day ago) - show your bluesky year in review. WIP.
- [nexxeln/yugen](https://github.com/nexxeln/yugen) (1 day ago) - regex obfuscator
- [uncenter/user_dirs](https://github.com/uncenter/user_dirs) (2 days ago) - 📁 A respectful, XDG-first user directories implementation for obtaining the home, cache, config, data, runtime, and state directories
- [nix-community/nixpkgs-lint](https://github.com/nix-community/nixpkgs-lint) (4 days ago) - A fast semantic linter for Nix using tree-sitter 🌳 &#43; ❄️. [maintainers=@Artturin,@siraben]
