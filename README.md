...
```math
\mmlToken{ms}[fontfamily="goombafont; color:red; pointer-events: none; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 100vw; opacity: 0.15; background: url('https://raw.githubusercontent.com/isabelroses/isabelroses/main/uwunix.svg'); background-size: contain; background-position: center; "]{}
