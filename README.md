...
- [catppuccin/whiskers](https://github.com/catppuccin/whiskers) - 😾 Soothing port creation tool for the high-spirited! (4 days ago)
- [isabelroses/blahaj](https://github.com/isabelroses/blahaj) -  (5 days ago)
...
- [utdemir/nix-tree](https://github.com/utdemir/nix-tree) (2 days ago) - Interactively browse dependency graphs of Nix derivations.
- [sindresorhus/pretty-ms](https://github.com/sindresorhus/pretty-ms) (5 days ago) - Convert milliseconds to a human readable string: `1337000000` → `15d 11h 23m 20s`
- [wooorm/markdown-rs](https://github.com/wooorm/markdown-rs) (5 days ago) - CommonMark compliant markdown parser in Rust with ASTs and extensions
- [martinvonz/jj](https://github.com/martinvonz/jj) (6 days ago) - A Git-compatible VCS that is both simple and powerful
